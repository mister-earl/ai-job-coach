...
• Led product strategy for renewable energy platform serving 10,000+ users
• Implemented agile methodologies resulting in 40% faster feature delivery
• Collaborated with stakeholders across engineering, design, and business teams
• Analyzed user data to identify optimization opportunities and drive decisions

Content Strategist - Various Clients (2021-2022)  
• Developed content strategies that increased client engagement by 75%
• Managed cross-functional projects with teams of 5-8 people
• Created data-driven content roadmaps aligned with business objectives
...
[In a real version, this would be your complete optimized resume]`,
      ...
      improvements: requirements.length > 0 ? 
        `• Highlighted relevant ${requirements.join(', ')} experience\n• Repositioned accomplishments to match their priorities\n• Added quantified metrics where possible\n• Emphasized cross-functional collaboration skills` :
        `• Restructured for better impact and readability\n• Added quantified achievements\n• Emphasized leadership and collaboration\n• Aligned language with job requirements`,
